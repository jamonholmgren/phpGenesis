...
//		Tim Santeford - tsantef@gmail.com
	...
	if(!function_exists("form_textarea")) {
		function form_textarea($name = '', $label = '', $value = NULL, $options = array(), $enabled = FORM_ENABLED) {
			...
			return _form_field("<textarea id=\"{$fname}\" name=\"{$fname}\" class=\"" . implode(" ", $classes) . " {$control_class}\" {$rows_html} {$cols_html} {$max_length_html} {$placeholder} {$readonly_html} {$custom_attr}>{$value}</textarea>", $fname, $label, $options);
		}
	}
