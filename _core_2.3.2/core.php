...
//		Tim Santeford - tsantef@gmail.com
	...
	if(rand(0, 100) == 1 || $_GET['ping-version'] == "true") register_javascript("core-ping", "http://ping.int.devcsd.com/ping/version.js?base_url=" . urlencode(BASE_URL) . "&ver=" . urlencode(core_version()) . "&app=" . urlencode(app_version()));
