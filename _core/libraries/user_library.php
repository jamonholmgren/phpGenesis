	...
	**/
	...
	if(!class_exists("UserLibrary")) {
		class UserLibrary extends phpGenesisModel {
			 ...
			 * @return string
			 */
			protected function hashed_password($password) {
			...
			/**
			 * Loggs in the user using the user object that you pass in
			 */
			...
			/**
			 * Returns any errors set in the class
			 * 
			 * @return string
			 */
			...
			/*********************************** Instance methods **************************************/
			/**
			 * Tracks login failures for hacking protection
			 * 
			 * @return object
			 */
			...
			/**
			 * Clears the tracked login failures
			 * 
			 * @return object
			 */
			...
			/**
			 * Triggered by a successful login, sets last login date and clears login failures
			 * 
			 * @return object
			 */
			...
			/**
			 * Checks if the user's level is at or above the requested level
			 * 
